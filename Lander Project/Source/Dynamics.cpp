...
//  vector3d virt_velocity = mars_lander.get_velocity();
//  vector3d virt_position = mars_lander.get_position;
//  double old_virt_velocity = virt_velocity.abs();
//  double virt_dt = 0.1;
//  double virt_time = virt_dt;
...
//    virt_mass = UNLOADED_LANDER_MASS + mars_lander.fuel*FUEL_CAPACITY*FUEL_DENSITY; //note this assumes effectively constant mass in virtual calulation
